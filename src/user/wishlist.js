                ...
                <div key={index} className="col-lg-3 mb-4">
                  <div className="text-center rounded shadow-lg">
                    ...
                    <div className="text-center mt-3">
                      <button className="btn btn-primary btn-sm m-2" onClick={saveCart.bind(this, pinfo)}>Move to Cart</button>
                      <button className="btn btn-warning btn-sm m-2" onClick={delItem.bind(this, pinfo.id, pinfo.name)}>Delete</button>
                    </div>
                  </div>
                </div>
              )
